...
part of 'jwt_token_controller_client.dart';
...
class _JwtTokenControllerClient implements JwtTokenControllerClient {
  _JwtTokenControllerClient(this._dio, {this.baseUrl, this.errorLogger});
