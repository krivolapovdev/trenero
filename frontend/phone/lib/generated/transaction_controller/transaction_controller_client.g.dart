...
part of 'transaction_controller_client.dart';
...
class _TransactionControllerClient implements TransactionControllerClient {
  _TransactionControllerClient(this._dio, {this.baseUrl, this.errorLogger});
