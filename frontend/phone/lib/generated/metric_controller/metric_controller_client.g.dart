...
part of 'metric_controller_client.dart';
...
class _MetricControllerClient implements MetricControllerClient {
  _MetricControllerClient(this._dio, {this.baseUrl, this.errorLogger});
