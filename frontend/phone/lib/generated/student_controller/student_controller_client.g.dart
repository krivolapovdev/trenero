...
part of 'student_controller_client.dart';
...
class _StudentControllerClient implements StudentControllerClient {
  _StudentControllerClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<StudentResponse>> getStudents() async {
  ...
  Future<StudentResponse> createStudent({
    ...
    final _options = _setStreamType<StudentResponse>(
    ...
    late StudentResponse _value;
    try {
      _value = StudentResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<StudentResponse> getStudent({required String studentId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
