...
part of 'group_controller_client.dart';
...
class _GroupControllerClient implements GroupControllerClient {
  _GroupControllerClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<GroupResponse> createGroup({required CreateGroupRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
